...
const NavBar = () => {
  ...
  return (
    <div className="navbar" style={{ 
      ...
      borderBottom: backgroundTransparent ? '2px solid rgba(128, 128, 128, 0.2)' : 'none'
    }}>
      ...
      <div className="flex items-center justify-between w-full">
        ...
        <Link href="/" className="flex">
          <Image 
          src={backgroundTransparent ? "/white-logo.png" : "/gray-logo.png"} 
          alt={"logo"} 
          width="50" 
          height="50" 
          />
        ...
        <div>
          <Image
          src={backgroundTransparent ? "/location-pin-white.svg" : "/location-pin-black.svg"}
          alt={"location-pin"}
          width="20"
          height="20"
          />
      ...
      {/* Mobile Menu */}
      <div
      className={`${isMobileMenuOpen ? "" : "hidden"} sm:hidden`}
      id="mobile-menu"
      >
